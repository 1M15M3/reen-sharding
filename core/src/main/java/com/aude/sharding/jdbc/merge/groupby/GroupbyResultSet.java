package com.aude.sharding.jdbc.merge.groupby;
...
import com.aude.sharding.jdbc.merge.orderby.OrderByComparetor;
        ...
        Arrays.sort(groupbyValues, new Comparator<GroupbyValue>() {
            ...
            public int compare(final GroupbyValue v1, final GroupbyValue v2) {
                try {
                    ...
                    throw new shardingException("Group by ...Order by... 排序失败" , e);
                }
            }
        });
    }
